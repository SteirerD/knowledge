      ...
      <div class="c-navbar-right">
          ...
          <div class="c-add-post__tooltip">
            <?php
              if(is_user_logged_in()) {
                echo '<div class="c-user-name">User: '.wp_get_current_user()->display_name.'</div>';
              } else {
                echo '<div class="c-user-name">Bitte loggen sie sich ein</div>';
              }
            ?>
          </div>
        </div>
        <div class="c-user-login">
          ...
          <?php
            ...
            <div class="c-user-login__tooltip-logout">ausloggen</div>
