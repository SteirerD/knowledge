      ...
      <div class="c-navbar-right">
        ...
        <div class="c-user-login">
          <?php if( ! is_user_logged_in()) : ?>
            <svg class="c-user-login__svg" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="sign-in-alt"
